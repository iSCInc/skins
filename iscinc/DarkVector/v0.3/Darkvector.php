...
class SkinDarkvector extends SkinTemplate {
	...
	var $skinname = 'darkvector', $stylename = 'darkvector',
		$template = 'DarkVectorTemplate', $useHeadElement = true;
	...
	public function initPage( OutputPage $out ) {
		...
		$out->addModuleScripts( 'skins.darkvector' );
...
$out->addStyle('darkvector/screen.css', 'screen');
	}
	...
	function setupSkinUserCss( OutputPage $out ){
		...
		$out->addModuleStyles( 'skins.darkvector' );
	}
